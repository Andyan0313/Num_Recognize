...
HD_PWD='D:/Xilinx/project/aaa/aaa.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log boundary_check.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source boundary_check.tcl
